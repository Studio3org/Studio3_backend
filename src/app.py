...
def create_app(config_overrides: dict | None = None):
    ...
    from src.modules.connect.connect_return_routes import connect_return_bp
    ...
    # No url_prefix, deliberately: Stripe redirects to /connect/return at the site root,
    # and the app claims that exact path as a Universal Link.
    app.register_blueprint(connect_return_bp)
